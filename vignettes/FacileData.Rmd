...
The `with_*` functions were written naturally combine in pipe (`%>%`) data manipulation
chains and provide analysts with a fluent and succinct API with which to perform
